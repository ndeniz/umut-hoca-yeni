...
public class Q200 {
    public static void main(String[] args) {
        ...
        ps.add(p2);     // burada deger bir daha baska bir degere assign yapilmak zorunda degil
                        // cunku burada ekleme
                        // yapiliyor

        //A int f=ps.indexOf(p2);// f int tipinde bir degisken oldugunu f>=0 dan anliyoruz .
        // O zaman bize int donduren bir method
        // akla getirmeli oda indexOf(p2)tur bir elemanin indexsini bulur
        //  indexlerde integerdir
      //  C  int f= ps.indexOf(new Patient("Mike")); //object bos olmus olur
